        ...
        <div className="flex items-center gap-2 border-t border-surface-100 px-3 py-2">
          {onEdit && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-transfer-700 bg-transfer-50 border border-transfer-200 rounded-lg active:bg-transfer-100 transition-colors"
            >
          ...
          {onDelete && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-error-700 bg-error-50 border border-error-200 rounded-lg active:bg-error-100 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
